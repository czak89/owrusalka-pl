        ...
        <div className="grid md:grid-cols-2 gap-8">
          {accommodationTypes.map((accommodation, index) => (
            <div key={index} className="bg-white rounded-xl shadow-lg overflow-hidden group hover:shadow-2xl transition-all duration-300">
              ...
              <div className="p-6">
                <h3 className="text-2xl font-bold mb-2 text-gray-800">{accommodation.name}</h3>
                ...
                <div className="border-t pt-4">
                  <h4 className="font-semibold mb-2 text-gray-800">Wyposażenie:</h4>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Szybkie łącze w całym ośrodku</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <Bed className="text-blue-600 mt-1" size={24} />
              <div>
                <h4 className="font-semibold text-gray-800">Pościel i ręczniki</h4>
                <p className="text-sm text-gray-600">Świeża bielizna pościelowa</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
