...
const services = [
  {
    ...
    title: "Wyżywienie",
    description:
      "Domowa kuchnia, 3 posiłki dziennie. Uwzględniamy diety specjalne.",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-16">
          ...
          <p className="text-xl text-center text-gray-600 mb-12 max-w-3xl mx-auto">
            Dbamy o każdy szczegół Twojego wypoczynku. Zobacz, co
        ...
        <div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {attractions.map((attraction, index) => (
              <div
                key={index}
                className="flex gap-4 bg-gray-50 rounded-lg p-4 hover:shadow-lg transition-shadow"
              >
        ...
        <div className="mt-12 text-center bg-blue-50 rounded-xl p-8">
          ...
          <p className="text-lg text-gray-600 mb-6 max-w-2xl mx-auto">
            Nie musisz martwić się o nic - my zadbamy o każdy szczegół Twojego
            wypoczynku. Przyjedź i ciesz się wakacjami!
          </p>
